...
class CampaignPost(Base):
    ...
    post_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("posts.id", ondelete="SET NULL"), nullable=True)
    order: Mapped[int] = mapped_column(Integer, default=0)
    scheduled_date: Mapped[str | None] = mapped_column(String, nullable=True)  # ISO date string
