            ...
            <div v-else class="space-y-1.5">
              ...
              >
                ...
                <div class="flex gap-0.5">
                  <button @click.stop="moveLayerUp(idx)" :disabled="idx === 0" class="text-gray-400 hover:text-gray-600 disabled:opacity-30" title="Nach oben">↑</button>
                  <button @click.stop="moveLayerDown(idx)" :disabled="idx === layers.length - 1" class="text-gray-400 hover:text-gray-600 disabled:opacity-30" title="Nach unten">↓</button>
                  <button @click.stop="duplicateLayer(idx)" class="text-gray-400 hover:text-blue-500" title="Duplizieren">⧉</button>
                  <button @click.stop="removeLayer(idx)" class="text-gray-400 hover:text-red-500" title="Loeschen">✕</button>
                </div>
              </div>
            </div>
          </div>
