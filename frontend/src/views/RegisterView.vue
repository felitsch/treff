      ...
      <div class="w-full max-w-md">
        ...
        <div class="mb-8">
          ...
          <p class="mt-2 text-gray-500 dark:text-gray-400">
            Registriere dich, um mit TREFF Content zu starten
          </p>
        </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                v-model="displayName"
                type="text"
                class="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 text-sm transition-all duration-200
                  focus:outline-none focus:ring-2 focus:ring-offset-1 focus:border-primary-500 focus:ring-primary-500/30
                  dark:bg-gray-800 dark:border-gray-600 dark:text-white dark:hover:border-gray-500
